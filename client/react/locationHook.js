...
export const TransitionProvider = ({ children }) => {
    ...
    return (React.createElement(NavigationStateContext.Provider, { value: { isNavigating: isPending, startTransition } }, children));
};
/**
...
export const useTransitionLocation = ({ base = '' } = {}) => {
    ...
    const navigate = useCallback((path, { replace = false } = {}) => {
        ...
        if (!router.navigationHistory)
            router.navigationHistory = {};
        if ((_a = router.navigationHistory) === null || _a === void 0 ? void 0 : _a.current) {
        ...
        history[replace ? eventReplaceState : eventPushState](null, '', 
...
export const navigatingOnSamePage = (history) => {
...
export const shouldScrollToHash = (history) => {
    var _a;
    return !(navigatingOnSamePage(history) && ((_a = history === null || history === void 0 ? void 0 : history.current) === null || _a === void 0 ? void 0 : _a.replace));
};
