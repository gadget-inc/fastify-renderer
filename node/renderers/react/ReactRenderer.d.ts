...
export declare class ReactRenderer implements Renderer {
    ...
    vitePlugins(): Plugin<any>[];
    clientModulePath(): Promise<string>;
    prepare(renderables: RenderableRegistration[], viteConfig: ResolvedConfig, devServer?: ViteDevServer): Promise<void>;
     ...
     */
    entrypointRequirePathForServer(register: RenderableRegistration): string;
    private startRenderBus;
    private renderStreamingTemplate;
    private renderSynchronousTemplate;
    private runPostRenderHeadHooks;
    private runHeadHooks;
    private runTailHooks;
