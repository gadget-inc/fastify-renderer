...
class ReactRenderer {
        ...
        this.wrappedRender = (0, tracing_1.wrap)('fastify-renderer.render', async (render) => {
            ...
            try {
                ...
                let app = (React.createElement(RenderBusContext.Provider, { value: bus },
                    React.createElement(Router, { base: render.base, hook: staticLocationHook(destination) },
                        React.createElement(Layout, { isNavigating: false, navigationDestination: destination, bootProps: render.props },
    ...
    entrypointScriptTagSrcForClient(render) {
        ...
        if (this.plugin.devMode) {
            ...
            const manifestEntryName = (0, node_1.normalizePath)(path_1.default.relative(this.viteConfig.root, entrypointName));
    ...
    hydrationEntrypointVitePlugin() {
        return {
          ...
          import { routes } from ${JSON.stringify(ReactRenderer.ROUTE_TABLE_ID + '?' + querystring_1.default.stringify({ base, lazy: true }))}
