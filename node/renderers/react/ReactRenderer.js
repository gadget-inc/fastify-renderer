...
class ReactRenderer {
    ...
    entrypointRequirePathForServer(id) {
        ...
        if (this.plugin.devMode) {
            ...
            if (!manifestEntry) {
                throw new Error(`Module id ${id} was not found in the built server entrypoints manifest. Looked for it at ${entrypointName} in virtual-manifest.json. Was it included in the build?`);
            }
