...
export declare type PartialRenderOptions = {
    layout: string;
    document: Template;
    base: string;
} | {
...
export declare function scriptTag(render: Render, content: string, attrs?: Record<string, string>): string;
export declare function stylesheetLinkTag(render: Render, href: string): string;
