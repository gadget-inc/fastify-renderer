...
class FastifyRendererPlugin {
    constructor(incomingOptions) {
        ...
        this.devMode = (_a = incomingOptions.devMode) !== null && _a !== void 0 ? _a : (process.env.NODE_ENV != 'production' || process.env.TEST == 'true');
        ...
        if (!this.devMode) {
            this.clientManifest = JSON.parse(node_fs_1.default.readFileSync(path_1.default.join(this.clientOutDir, 'manifest.json'), 'utf-8'));
            this.serverEntrypointManifest = JSON.parse(node_fs_1.default.readFileSync(path_1.default.join(this.serverOutDir, 'virtual-manifest.json'), 'utf-8'));
        }
